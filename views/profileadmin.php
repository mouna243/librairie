        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">
                    HI, <span class="text-orange-900"><?= $admin->getFirstname(); ?></span>
                </h1>
                    ...
                    <div class="h-40 bg-gradient-to-r from-orange-300 to-orange-900 relative">
                        <div class="absolute ">
                            <div class="w-32 h-32 bg-white rounded-full border-4 border-white shadow-xl flex items-center justify-center">
                                <i class="fa-solid fa-book-open-admin text-[70px] text-orange-900"></i>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="flex flex-col p-4 bg-white rounded-lg shadow-sm">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-medium text-gray-900"><?= $admin->getFirstname(); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col p-4 bg-white rounded-lg shadow-sm">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-medium text-gray-900"><?= $admin->getLastname(); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col p-4 bg-white rounded-lg shadow-sm">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-medium text-gray-900"><?= $admin->getEmail(); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
?>
book (edit , delet , ajouter) 

<br>
profil (firstname, lastname ,email );
<br>
all the books borrowed -->