...
<head>
   ...
   <?php require_once __DIR__."/../app/controllers/logintra.php";
        $class = new login();
        $class->login();
...
<h1 class="font-dancing text-[50px] text-orange-900 font-medium block mb-2">Wecome Reader</h1>
            ...
            <div class="mt-8 text-center">
                <p class="font-dancing text-lg text-[#682f03a3]">
                    Nouveau ici ?
                    <a href="signin" class="text-[#ffc090ff] font-bold hover:underline ml-1">Créer un compte</a>
                </p>
            </div>
        </div>
    </div>
