<head>
    ...
    <style>
        .font-dancing {
            ...
            /* background-color: #4e2601; */

        }
    </style>
</head>
<?php
require_once __DIR__ . "/../app/controllers/loginadmincontroller.php";
...
<body>
    <div
        ...
        <div class="bg-white/10 backdrop-blur-sm rounded-2xl shadow-2xl p-8 max-w-md w-full border border-white/20">
            <h1 class="font-dancing text-[50px] text-orange-900 font-medium block mb-2">Wecome Mr Admin</h1>

            <form class="space-y-6" method="POST">
                <div>
                    <label for="name" class="font-dancing text-xl text-[#682f03a3] font-medium block mb-2">EMAIL</label>
                ...
                <div>
                    <label for="pw" class="font-dancing text-xl text-[#682f03a3] font-medium block mb-2">MOT DE
                        PASSE</label>
            ...
            <div class="mt-8 text-center">
                <p class="font-dancing text-lg text-[#682f03a3]">
                    Nouveau ici ?
                    <a href="singadmin" class="text-[#ffc090ff] font-bold hover:underline ml-1">Créer un compte</a>
                </p>
            </div>
        </div>
    </div>
